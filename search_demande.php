...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['search'])) {
        ...
        $demandes = $demandeDAO->searchDemandes($lieuAdresse, $lieuVille, $lieuCodePostal, $festivalId, $dateDepart);
    }
}
...
debug_to_console("demandes contient " . count($demandes) . " éléments.");
...
<body>
    ...
    <main>
        <section>
            ...
            <hr>
            <?php
            echo displayDemandes($demandes, 'home');
            ?>
        </section>
    </main>
</body>
